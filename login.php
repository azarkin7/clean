...
<div class="row">
	<div class="col-md-4">
		<p class="reginform">
			Выберите реферала <span class="zvezda">*</span>
		</p>	</div>
		<div class="col-md-8">
			<select class="sel" name="select" id="input16">
				<option value="masha1">Мария</option>
				<option value="evg2">Евгения</option>
				<option value="ekat3">Екатерина</option>
				<option value="vas4">Василиса</option>
			</select>
		</div>
</div>
<div class="row">
